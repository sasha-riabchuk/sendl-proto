...
const (
	PlatformService_GetTokensForAppUserID_FullMethodName = "/platform.PlatformService/GetTokensForAppUserID"
)
...
type PlatformServiceClient interface {
	GetTokensForAppUserID(ctx context.Context, in *GetTokensRequest, opts ...grpc.CallOption) (*GetTokensResponse, error)
}
...
func (c *platformServiceClient) GetTokensForAppUserID(ctx context.Context, in *GetTokensRequest, opts ...grpc.CallOption) (*GetTokensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTokensResponse)
	err := c.cc.Invoke(ctx, PlatformService_GetTokensForAppUserID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlatformServiceServer interface {
	GetTokensForAppUserID(context.Context, *GetTokensRequest) (*GetTokensResponse, error)
...
func (UnimplementedPlatformServiceServer) GetTokensForAppUserID(context.Context, *GetTokensRequest) (*GetTokensResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTokensForAppUserID not implemented")
}
...
func _PlatformService_GetTokensForAppUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTokensRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlatformServiceServer).GetTokensForAppUserID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlatformService_GetTokensForAppUserID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlatformServiceServer).GetTokensForAppUserID(ctx, req.(*GetTokensRequest))
	}
...
var PlatformService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTokensForAppUserID",
			Handler:    _PlatformService_GetTokensForAppUserID_Handler,
		},
	},
