...
const file_media_media_proto_rawDesc = "" +
	...
	"\tcover_url\x18\x04 \x01(\tR\bcoverUrl\"G\n" +
	"\tMediaItem\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x14\n" +
	"\x05order\x18\x03 \x01(\x05R\x05order2l\n" +
	"\fMediaService\x12\\\n" +
	"\x13GetMediaForUploadID\x12!.media.GetMediaForUploadIDRequest\x1a\".media.GetMediaForUploadIDResponseB:Z8github.com/sasha-riabchuk/sendl-proto/gen/go/media;mediab\x06proto3"
...
var file_media_media_proto_goTypes = []any{
	...
	(*MediaItem)(nil),                   // 2: media.MediaItem
}
var file_media_media_proto_depIdxs = []int32{
	2, // 0: media.GetMediaForUploadIDResponse.medias:type_name -> media.MediaItem
	0, // 1: media.MediaService.GetMediaForUploadID:input_type -> media.GetMediaForUploadIDRequest
	1, // 2: media.MediaService.GetMediaForUploadID:output_type -> media.GetMediaForUploadIDResponse
